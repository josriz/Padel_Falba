// src/components/Dashboard.jsx - ✅ SIDEBAR DA DESTRA LAYTONIC STYLE!
        ...
        <div className="p-4 space-y-2 overflow-y-auto h-[calc(100vh-200px)]">
          {menuItems.map((item) => (
            <button
              ...
              className={`w-full flex items-center gap-4 p-4 rounded-2xl font-medium transition-all group text-left ${
