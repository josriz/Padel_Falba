...
const Auth = () => {
    ...
    return (
        <div className="bg-white p-10 rounded-3xl max-w-md w-full mx-auto shadow-md flex flex-col min-h-[80vh]">
            <div className="flex flex-col items-center mb-8">
                <img src="/logo.png" alt="Logo Padel Club" className="max-w-[120px] mb-1" />
                <p className="text-xs italic lowercase mb-4 text-gray-500">by Claudio Falba</p>
            ...
            <div className="relative my-6 flex items-center">
                ...
                <span className="absolute left-1/2 -translate-x-1/2 bg-white px-3 text-gray-400 text-sm">o</span>
                <hr className="flex-grow border-t border-gray-300" />
            </div>
            ...
            <div className="mt-6 text-center border-t border-gray-200 pt-5">
                ...
                <p className="mt-2 text-xs italic lowercase text-gray-500 max-w-xs mx-auto">
                    Continuando, accetti i nostri{' '}
                    <a href="http://localhost:5173/terms" target="_blank" className="underline text-blue-600">
                        Termini di Servizio
                    </a>{' '}
                    e{' '}
                    <a href="http://localhost:5173/privacy" target="_blank" className="underline text-blue-600">
                        Politica sulla Privacy
                    </a>. I tuoi dati saranno utilizzati nel rispetto della normativa vigente per offrirti la miglior esperienza possibile. @ josè rizzi
                </p>
            </div>
        </div>
    );
