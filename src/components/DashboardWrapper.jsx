...
import { Home, Calendar, LogOut, Menu, Award, ShoppingBag, Settings } from "lucide-react";
...
const navigation = [
  ...
  { name: 'Gestione Eventi', href: '/dashboard/gestione-eventi', icon: Award }, // aggiunto Gestione Eventi
  { name: 'Profilo', href: '/dashboard/profilo', icon: Settings },
];

const DashboardWrapper = ({ user, isAdmin, onLogout }) => {
    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-t border-gray-200">
          <button onClick={onLogout} className="w-full flex items-center justify-center px-4 py-3 text-sm font-semibold rounded-lg text-red-600 bg-red-100 hover:bg-red-200 transition">
