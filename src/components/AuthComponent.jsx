    ...
    <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
      <View style={styles.card}>
        ...
        <View style={styles.links}>
          {mode !== "login" && <TouchableOpacity onPress={() => setMode("login")}><Text style={styles.linkText}>Torna al login</Text></TouchableOpacity>}
          {mode === "login" && (
            <>
              <TouchableOpacity onPress={() => setMode("register")}><Text style={styles.linkText}>Registrati</Text></TouchableOpacity>
              <TouchableOpacity onPress={() => setMode("reset")}><Text style={styles.linkText}>Password dimenticata?</Text></TouchableOpacity>
            </>
          )}
        </View>
      </View>
...
const styles = StyleSheet.create({
  scrollContainer: { flexGrow: 1, justifyContent: "center", padding: 20, backgroundColor: "#0f172a" },
  card: { backgroundColor: "#1e293b", padding: 24, borderRadius: 16, width: "100%", maxWidth: 400, alignSelf: "center" },
  logo: { width: 120, height: 120, alignSelf: "center", marginBottom: 20, borderRadius: 16 },
  title: { fontSize: 26, fontWeight: "700", color: "#f1f5f9", marginBottom: 20, textAlign: "center" },
  input: { backgroundColor: "#334155", borderRadius: 8, height: 48, paddingHorizontal: 14, color: "#f8fafc", marginBottom: 12 },
  button: { borderRadius: 8, paddingVertical: 14, alignItems: "center", marginBottom: 12 },
