    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 pt-4 pb-12">
      <div className="p-6 max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center">
          <div className="w-20 h-20 bg-yellow-100 rounded-xl mx-auto mb-4 flex items-center justify-center shadow-sm border border-gray-200">
            ...
            {tournaments.map((t) => (
              ...
              >
                ...
                <div className="p-6 pt-0">
                  <div className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white font-bold py-3 px-6 rounded-xl shadow-sm group-hover:shadow-md group-hover:scale-[1.02] transition-all text-sm">
                    {isAdmin ? (
                      <>
