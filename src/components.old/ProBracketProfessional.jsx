// ProBracketProfessional.jsx
import React, { useState, useEffect } from "react";
import { supabase } from "../supabaseClient";
import BackButton from "./BackButton";

export default function ProBracketProfessional({ user }) {
  ...
  const MatchCard = ({ match, roundIndex, matchIndex }) => {
    ...
    return (
      ...
      onClick={() => isAdmin && winner && propagateWinner(roundIndex, matchIndex, match.winner)}
      >
  ...
  return (
    <div style={{ maxWidth: 1400, margin: "20px auto", padding: 20, fontFamily: "Arial, sans-serif" }}>
      <BackButton />
      ...
      <div style={{ display: "flex", gap: 30, flexWrap: "wrap" }}>
        {bracket.map((round, i) => (
          <div key={`round-${i}`} style={{ flex: 1, minWidth: 220 }}>
